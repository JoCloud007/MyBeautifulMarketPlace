...
export default function QueryError({ message = "Unable to load data.", onRetry }: QueryErrorProps) {
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-slate-800 bg-slate-900/50 p-12 text-center animate-fade-in">
      ...
      <h3 className="mt-4 text-lg font-medium text-white">Loading error</h3>
