...
describe('Admin Routes', () => {
    ...
    describe('GET /api/admin/dashboard', () => {
        it('should return counts and recent forecasts', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).get('/api/admin/dashboard');
    ...
    describe('GET /api/admin/products', () => {
        it('should list products with category, flavors and forecast count', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).get('/api/admin/products');
            expect(res.status).toBe(200);
    ...
    describe('POST /api/admin/products', () => {
        it('should create a product', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).post('/api/admin/products').send(payload);
    ...
    describe('PATCH /api/admin/products/:id', () => {
        it('should update a product', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).patch('/api/admin/products/p1').send({ name: 'Updated VM' });
            expect(res.status).toBe(200);
    ...
    describe('DELETE /api/admin/products/:id', () => {
        it('should delete a product', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).delete('/api/admin/products/p1');
    ...
    describe('POST /api/admin/products/:id/flavors', () => {
        it('should create a flavor under a product', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).post('/api/admin/products/p1/flavors').send(payload);
            expect(res.status).toBe(201);
            expect(res.body).toEqual(created);
    ...
    describe('POST /api/admin/categories', () => {
        it('should create a category', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).post('/api/admin/categories').send(payload);
            expect(res.status).toBe(201);
            expect(res.body).toEqual(created);
        });
    });
    describe('PATCH /api/admin/categories/:id', () => {
        it('should update a category', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).patch('/api/admin/categories/c1').send({ description: 'Updated' });
            expect(res.status).toBe(200);
    ...
    describe('DELETE /api/admin/categories/:id', () => {
        it('should delete a category', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).delete('/api/admin/categories/c1');
            expect(res.status).toBe(204);
        });
    });
    describe('GET /api/admin/flavors', () => {
        it('should list flavors with product and forecast count', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).get('/api/admin/flavors');
            expect(res.status).toBe(200);
    ...
    describe('PATCH /api/admin/flavors/:id', () => {
        it('should update a flavor', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).patch('/api/admin/flavors/fl1').send({ vcpu: 4 });
            expect(res.status).toBe(200);
    ...
    describe('DELETE /api/admin/flavors/:id', () => {
        it('should delete a flavor', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).delete('/api/admin/flavors/fl1');
            expect(res.status).toBe(204);
        });
    });
    describe('GET /api/admin/dependencies', () => {
        it('should list dependencies with product and dependsOn', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).get('/api/admin/dependencies');
            expect(res.status).toBe(200);
    ...
    describe('POST /api/admin/dependencies', () => {
        it('should create a dependency', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).post('/api/admin/dependencies').send(payload);
            expect(res.status).toBe(201);
            expect(res.body).toEqual(created);
        });
    ...
    describe('PATCH /api/admin/dependencies/:id', () => {
        it('should update a dependency type', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).patch('/api/admin/dependencies/d1').send({ type: 'REQUIRED' });
            expect(res.status).toBe(200);
    ...
    describe('DELETE /api/admin/dependencies/:id', () => {
        it('should delete a dependency', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).delete('/api/admin/dependencies/d1');
            expect(res.status).toBe(204);
        });
    });
    describe('GET /api/admin/forecasts', () => {
        it('should list all forecasts', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).get('/api/admin/forecasts');
            expect(res.status).toBe(200);
    ...
    describe('GET /api/admin/users', () => {
        it('should list users ordered by createdAt desc', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).get('/api/admin/users');
            expect(res.status).toBe(200);
    ...
    describe('POST /api/admin/users', () => {
        it('should create a user', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).post('/api/admin/users').send(payload);
            expect(res.status).toBe(201);
            expect(res.body).toEqual(created);
        });
    ...
    describe('PATCH /api/admin/users/:id', () => {
        it('should update a user', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).patch('/api/admin/users/u1').send({ name: 'Alice Updated' });
            expect(res.status).toBe(200);
    ...
    describe('DELETE /api/admin/users/:id', () => {
        it('should delete a user', async () => {
            ...
            const app = createApp();
            const res = await (0, supertest_1.default)(app).delete('/api/admin/users/u1');
            expect(res.status).toBe(204);
        });
    });
});
